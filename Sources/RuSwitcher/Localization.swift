...
enum L10n {
    ...
    static var settingsAdaptiveAutoSwitch: String { s("settings.adaptiveAutoSwitch") }
    static var settingsAdaptiveAutoSwitchHint: String { s("settings.adaptiveAutoSwitch.hint") }
    static var settingsClearLearnedWords: String { s("settings.clearLearnedWords") }
    ...
    private static let strings: [String: [String: String]] = [
        ...
        "en": [
            ...
            "settings.adaptiveAutoSwitch": "Adaptive auto-switching",
            "settings.adaptiveAutoSwitch.hint": "RuSwitcher learns locally from words that you correct with the trigger. Text is not sent to the internet or stored in plain text.",
            "settings.clearLearnedWords": "Clear learned words",
        ...
        "ru": [
            ...
            "settings.adaptiveAutoSwitch": "Адаптивное автопереключение",
            "settings.adaptiveAutoSwitch.hint": "RuSwitcher локально обучается на словах, которые вы исправляете триггером. Текст не передаётся в интернет и не сохраняется в открытом виде.",
            "settings.clearLearnedWords": "Очистить выученные слова",
        ...
        "de": [
            ...
            "settings.adaptiveAutoSwitch": "Adaptives automatisches Umschalten",
            "settings.adaptiveAutoSwitch.hint": "RuSwitcher lernt lokal aus Wörtern, die Sie mit dem Auslöser korrigieren. Text wird weder ins Internet übertragen noch im Klartext gespeichert.",
            "settings.clearLearnedWords": "Gelernte Wörter löschen",
        ...
        "fr": [
            ...
            "settings.adaptiveAutoSwitch": "Basculement automatique adaptatif",
            "settings.adaptiveAutoSwitch.hint": "RuSwitcher apprend localement les mots que vous corrigez avec le déclencheur. Le texte n’est ni envoyé sur Internet ni stocké en clair.",
            "settings.clearLearnedWords": "Effacer les mots appris",
        ...
        "es": [
            ...
            "settings.adaptiveAutoSwitch": "Cambio automático adaptativo",
            "settings.adaptiveAutoSwitch.hint": "RuSwitcher aprende localmente de las palabras que corriges con el disparador. El texto no se envía a Internet ni se guarda en texto sin cifrar.",
            "settings.clearLearnedWords": "Borrar palabras aprendidas",
        ...
        "pt": [
            ...
            "settings.adaptiveAutoSwitch": "Alternância automática adaptativa",
            "settings.adaptiveAutoSwitch.hint": "O RuSwitcher aprende localmente com palavras corrigidas pelo gatilho. O texto não é enviado à Internet nem salvo em texto simples.",
            "settings.clearLearnedWords": "Limpar palavras aprendidas",
        ...
        "zh": [
            ...
            "settings.adaptiveAutoSwitch": "自适应自动切换",
            "settings.adaptiveAutoSwitch.hint": "RuSwitcher 会从您用触发键纠正的词语中在本地学习。文本不会发送到互联网，也不会以明文保存。",
            "settings.clearLearnedWords": "清除已学习的词语",
        ...
        "ja": [
            ...
            "settings.adaptiveAutoSwitch": "適応型自動切り替え",
            "settings.adaptiveAutoSwitch.hint": "RuSwitcher はトリガーで修正した単語からローカルで学習します。テキストがインターネットへ送信されたり、平文で保存されたりすることはありません。",
            "settings.clearLearnedWords": "学習した単語を消去",
        ...
        "ko": [
            ...
            "settings.adaptiveAutoSwitch": "적응형 자동 전환",
            "settings.adaptiveAutoSwitch.hint": "RuSwitcher는 트리거로 수정한 단어에서 로컬로 학습합니다. 텍스트는 인터넷으로 전송되거나 평문으로 저장되지 않습니다.",
            "settings.clearLearnedWords": "학습한 단어 지우기",
        ...
        "uk": [
            ...
            "settings.adaptiveAutoSwitch": "Адаптивне автоперемикання",
            "settings.adaptiveAutoSwitch.hint": "RuSwitcher локально навчається на словах, які ви виправляєте тригером. Текст не передається в інтернет і не зберігається відкритим.",
            "settings.clearLearnedWords": "Очистити вивчені слова",
        ...
        "be": [
            ...
            "settings.adaptiveAutoSwitch": "Адаптыўнае аўтапераключэнне",
            "settings.adaptiveAutoSwitch.hint": "RuSwitcher лакальна навучаецца на словах, якія вы выпраўляеце трыгерам. Тэкст не перадаецца ў інтэрнэт і не захоўваецца адкрыта.",
            "settings.clearLearnedWords": "Ачысціць вывучаныя словы",
        ...
        "pl": [
            ...
            "settings.adaptiveAutoSwitch": "Adaptacyjne automatyczne przełączanie",
            "settings.adaptiveAutoSwitch.hint": "RuSwitcher uczy się lokalnie na słowach poprawianych wyzwalaczem. Tekst nie jest wysyłany do Internetu ani zapisywany otwartym tekstem.",
            "settings.clearLearnedWords": "Wyczyść wyuczone słowa",
        ...
        "el": [
            ...
            "settings.adaptiveAutoSwitch": "Προσαρμοστική αυτόματη εναλλαγή",
            "settings.adaptiveAutoSwitch.hint": "Το RuSwitcher μαθαίνει τοπικά από λέξεις που διορθώνετε με το πλήκτρο ενεργοποίησης. Το κείμενο δεν αποστέλλεται στο διαδίκτυο ούτε αποθηκεύεται ως απλό κείμενο.",
            "settings.clearLearnedWords": "Εκκαθάριση μαθημένων λέξεων",
        ...
        "bg": [
            ...
            "settings.adaptiveAutoSwitch": "Адаптивно автоматично превключване",
            "settings.adaptiveAutoSwitch.hint": "RuSwitcher се обучава локално от думи, които поправяте с тригера. Текстът не се изпраща в интернет и не се съхранява като обикновен текст.",
            "settings.clearLearnedWords": "Изчистване на научените думи",
        ...
        "hy": [
            ...
            "settings.adaptiveAutoSwitch": "Հարմարվողական ավտոմատ փոխարկում",
            "settings.adaptiveAutoSwitch.hint": "RuSwitcher-ը տեղայնորեն սովորում է բառերից, որոնք ուղղում եք գործարկիչով։ Տեքստը չի ուղարկվում համացանց և չի պահվում բաց տեսքով։",
            "settings.clearLearnedWords": "Մաքրել սովորած բառերը",
        ...
        "ka": [
            ...
            "settings.adaptiveAutoSwitch": "ადაპტური ავტომატური გადართვა",
            "settings.adaptiveAutoSwitch.hint": "RuSwitcher ადგილობრივად სწავლობს სიტყვებს, რომლებსაც ტრიგერით ასწორებთ. ტექსტი ინტერნეტში არ იგზავნება და ღია სახით არ ინახება.",
            "settings.clearLearnedWords": "ნასწავლი სიტყვების გასუფთავება",
